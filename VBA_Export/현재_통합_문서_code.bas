...
Private Sub Workbook_Open()
    ...
    ThisWorkbook.Worksheets("HideSheet").Range("N2").Value = AppVersion
...
'    End If
    ...
    ThisWorkbook.Worksheets("CoAMaster").Protect PASSWORD_WS, UserInterfaceOnly:=True, AllowFiltering:=True
    ThisWorkbook.Worksheets("CorpCoA").Protect PASSWORD_WS, UserInterfaceOnly:=True, AllowFiltering:=True
    ThisWorkbook.Worksheets("BSPL").Protect PASSWORD_WS, UserInterfaceOnly:=True, AllowFiltering:=True
    ThisWorkbook.Worksheets("CorpMaster").Protect PASSWORD_WS, UserInterfaceOnly:=True, AllowFiltering:=True
    ThisWorkbook.Worksheets("Verify").Protect PASSWORD_WS, UserInterfaceOnly:=True
    ThisWorkbook.Worksheets("Check").Protect PASSWORD_WS, UserInterfaceOnly:=True
    ThisWorkbook.Worksheets("ADBS").Protect PASSWORD_WS, UserInterfaceOnly:=True, AllowFiltering:=True
    ThisWorkbook.Worksheets("AddCoA_ADBS").Protect PASSWORD_WS, UserInterfaceOnly:=True
    ThisWorkbook.Worksheets("AddCoA").Protect PASSWORD_WS, UserInterfaceOnly:=True
