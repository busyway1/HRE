...
'  - Variant suffix detection (_���ΰŷ�, _IC)
...
Sub Fill_Input_Table()
   ...
   With tblRawCoA.Range
        ...
        Set searchrange = Intersect(filteredData, tblRawCoA.ListColumns(2).Range)  ' Column 2: �����ڵ�
        ...
        For Each area In searchrange.Areas
            For Each cell In area
                ...
                accountCode = cell.Value  ' �����ڵ� (e.g., "10300", "11401_���ΰŷ�")
        ...
        For Each coaRow In tblCoA.ListRows
            ...
            ' Lookup strategy:
            ' 1. Try exact variant match (e.g., 11401_���ΰŷ� �� INTERCO_KR variant)
            ' 2. Fallback to BASE variant (e.g., 11401_���ΰŷ� �� 11401 BASE mapping)
...
Sub Fill_CoA_Table()
    ...
    Call OpenProgress("CoA �߰� �۾� ������")

    ' Process each input row
    Dim key As String
    For i = 1 To UBound(inputData)
        Call CalculateProgress(i / UBound(inputData), "CoA �߰� ��...")
    ...
    ' Log activity
    LogData CorpCoA.Name, "<CoA �뷮�߰�>" & vbNewLine & vbNewLine & _
            "�����ڵ� | ���κ� CoA | ���κ� ��������� | PwC_CoA | PwC_������ | ���" & vbNewLine & _
            totalLogString
    ...
    Call SpeedDown
    MsgBox "CoA�� ���κ�CoA�� �߰��Ǿ����ϴ�.", vbInformation, AppName & " " & AppType
    MsgBox "CoA Ȯ�� �� ������ �ջ��� �ٽ� ����" & vbNewLine & "�Ͽ� ����� Ȯ���ϼ���.", vbInformation, AppName & " " & AppType
...
Private Function GetVariantType(accountCode As String) As String
    If InStr(accountCode, "_���ΰŷ�") > 0 Then
